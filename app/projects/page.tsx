...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Technical projects and achievements spanning performance optimization, platform migrations, SEO, monetization, and social impact at scale.',
    openGraph: {
      title: 'Projects | Richard Dillman',
      description:
        'Technical projects spanning performance optimization, platform migrations, SEO, and social impact at scale.',
    ...
    twitter: {
      ...
      description:
        'Technical projects spanning performance optimization, platform migrations, SEO, and social impact at scale.',
      images: [
        '/api/og?title=Technical Projects&description=26 years of solving complex technical challenges at scale',
      ],
    },
    other: {
      'script:ld+json': JSON.stringify(projectsSchema),
    },
  };
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-12 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              26 years of solving complex technical challenges at scale. From government digital
              transformation to premium media platforms serving hundreds of millions of users.
            </p>
          </header>
                ...
                details={
                  <div className="space-y-6 pt-4">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-700 dark:text-neutral-300">{project.outcome}</p>
                    </div>
