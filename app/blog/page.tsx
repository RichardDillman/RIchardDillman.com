  ...
  return {
    ...
    twitter: {
      ...
      description:
        'Technical writing on React, performance optimization, web development, and engineering leadership.',
      images: [
        '/api/og?title=Blog&description=Technical writing on React, performance optimization, and engineering leadership',
      ],
    },
    other: {
        ...
        <div className="max-w-4xl mx-auto">
          <header className="mb-12 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-6">
              Technical writing on React, performance optimization, web development, and
              engineering leadership. Originally published on{' '}
              <a
